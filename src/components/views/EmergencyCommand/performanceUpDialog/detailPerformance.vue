<template>
	<div class="public-form inner-container">
		...
		<el-table :data="tableData" style="width: 100%" border>
			<el-table-column type="index" label="序号" min-width="70" show-overflow-tooltip>
			</el-table-column>
			<el-table-column prop="title" label="任务" min-width="29%" show-overflow-tooltip>
			</el-table-column>
			<el-table-column prop="typeName" label="类型" min-width="11%" show-overflow-tooltip>
			</el-table-column>
			<el-table-column prop="endTime" label="办结时间" min-width="23%" show-overflow-tooltip>
			</el-table-column>
			<el-table-column prop="score" label="满意度得分" min-width="18%" show-overflow-tooltip>
			</el-table-column>
			<el-table-column prop="agingScore" label="时效得分" min-width="12%" show-overflow-tooltip>
			</el-table-column>
		</el-table>
